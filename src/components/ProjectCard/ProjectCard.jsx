...
const ProjectCard = ({ project }) => {
  ...
  return (
    <div className="bg-[#1A1F2E] min-h-[600px] lg:min-h-[550px] rounded-2xl overflow-hidden shadow-lg hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex flex-col">
      <img
        src={image}
        alt={title}
